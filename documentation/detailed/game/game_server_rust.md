...
- **`packet/`:** Defines the network packets that are used to communicate with clients. For a detailed explanation of the protocol, see the [Networking Protocol](./networking.md) document.

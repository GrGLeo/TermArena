...
import (
	...
	"github.com/GrGLeo/TermArena/services/room_manager_service/config"
	"github.com/GrGLeo/TermArena/services/room_manager_service/internal"
)
...
func NewLogger(level string) *slog.Logger {
	...
	return slog.New(handler).With("component", "room_manager")
}
...
func main() {
	...
	server := internal.NewRoomServer(config, logger)
	...
	<-quit
	logger.Debug("Shutting down Room manager service ...")

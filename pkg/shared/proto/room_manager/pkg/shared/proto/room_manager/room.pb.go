...
type RoomChangeNotification struct {
	...
	Dummy         string                 `protobuf:"bytes,4,opt,name=dummy,proto3" json:"dummy,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *RoomChangeNotification) GetDummy() string {
	if x != nil {
		return x.Dummy
	}
	return ""
...
const file_pkg_proto_room_managing_room_proto_rawDesc = "" +
	...
	"\n" +
	"user_infos\x18\x03 \x03(\v2\x16.room_manager.UserInfoR\tuserInfos\x12\x14\n" +
	"\x05dummy\x18\x04 \x01(\tR\x05dummy\"\x1f\n" +
	"\x03Ack\x12\x18\n" +

...
type UserInfo struct {
	...
	Spell1        string                 `protobuf:"bytes,3,opt,name=spell1,proto3" json:"spell1,omitempty"`
	Spell2        string                 `protobuf:"bytes,4,opt,name=spell2,proto3" json:"spell2,omitempty"`
...
func (x *UserInfo) GetSpell1() string {
	if x != nil {
		return x.Spell1
	}
	return ""
...
func (x *UserInfo) GetSpell2() string {
	if x != nil {
		return x.Spell2
	}
	return ""
...
type RoomInfo struct {
	...
	RoomPort      string                 `protobuf:"bytes,2,opt,name=roomPort,proto3" json:"roomPort,omitempty"`
...
func (x *RoomInfo) GetRoomPort() string {
	if x != nil {
		return x.RoomPort
	}
	return ""
...
func (x *LookRoomRequest) GetRoomType() string {
	if x != nil {
		return x.RoomType
	}
	return ""
...
func (x *LookRoomResponse) GetRoom() []*RoomInfo {
	if x != nil {
		return x.Room
	}
	return nil
...
type UpdateSpellRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Username      string                 `protobuf:"bytes,1,opt,name=username,proto3" json:"username,omitempty"`
	Spell1        string                 `protobuf:"bytes,2,opt,name=spell1,proto3" json:"spell1,omitempty"`
	Spell2        string                 `protobuf:"bytes,3,opt,name=spell2,proto3" json:"spell2,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UpdateSpellRequest) GetSpell1() string {
	if x != nil {
		return x.Spell1
	}
	return ""
...
func (x *UpdateSpellRequest) GetSpell2() string {
	if x != nil {
		return x.Spell2
	}
	return ""
...
func (x *RoomDoneRequest) GetRoomID() string {
	if x != nil {
		return x.RoomID
	}
	return ""
...
func (x *QuitRoomRequest) GetRoomID() string {
	if x != nil {
		return x.RoomID
	}
	return ""
...
const file_pkg_proto_room_managing_room_proto_rawDesc = "" +
	...
	"\x06spell1\x18\x03 \x01(\tR\x06spell1\x12\x16\n" +
	"\x06spell2\x18\x04 \x01(\tR\x06spell2\"Z\n" +
	"\bRoomInfo\x12\x16\n" +
	"\x06roomID\x18\x01 \x01(\tR\x06roomID\x12\x1a\n" +
	"\broomPort\x18\x02 \x01(\tR\broomPort\x12\x1a\n" +
	"\broomType\x18\x03 \x01(\tR\broomType\"I\n" +
	"\x0fLookRoomRequest\x12\x1a\n" +
	"\busername\x18\x01 \x01(\tR\busername\x12\x1a\n" +
	"\broomType\x18\x02 \x01(\tR\broomType\">\n" +
	"\x10LookRoomResponse\x12*\n" +
	"\x04room\x18\x01 \x03(\v2\x16.room_manager.RoomInfoR\x04room\"`\n" +
	"\x12UpdateSpellRequest\x12\x1a\n" +
	"\busername\x18\x01 \x01(\tR\busername\x12\x16\n" +
	"\x06spell1\x18\x02 \x01(\tR\x06spell1\x12\x16\n" +
	"\x06spell2\x18\x03 \x01(\tR\x06spell2\"-\n" +
	...
	"\x05users\x18\x01 \x03(\v2\x16.room_manager.UserInfoR\x05users2\x8d\x03\n" +
	"\vRoomService\x12I\n" +
	"\bLookRoom\x12\x1d.room_manager.LookRoomRequest\x1a\x1e.room_manager.LookRoomResponse\x12R\n" +
	"\vUpdateSpell\x12 .room_manager.UpdateSpellRequest\x1a!.room_manager.UpdateSpellResponse\x12I\n" +
	"\bRoomDone\x12\x1d.room_manager.RoomDoneRequest\x1a\x1e.room_manager.RoomDoneResponse\x12I\n" +
	"\bQuitRoom\x12\x1d.room_manager.QuitRoomRequest\x1a\x1e.room_manager.QuitRoomResponse\x12I\n" +
	"\bRoomInfo\x12\x1d.room_manager.RoomInfoRequest\x1a\x1e.room_manager.RoomInfoResponseB\x1fZ\x1dpkg/shared/proto/room_managerb\x06proto3"
...
var file_pkg_proto_room_managing_room_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_pkg_proto_room_managing_room_proto_goTypes = []any{
	(*UserInfo)(nil),            // 0: room_manager.UserInfo
	(*RoomInfo)(nil),            // 1: room_manager.RoomInfo
	...
	(*RoomInfoRequest)(nil),     // 10: room_manager.RoomInfoRequest
	(*RoomInfoResponse)(nil),    // 11: room_manager.RoomInfoResponse
}
var file_pkg_proto_room_managing_room_proto_depIdxs = []int32{
	1,  // 0: room_manager.LookRoomResponse.room:type_name -> room_manager.RoomInfo
	0,  // 1: room_manager.RoomInfoResponse.users:type_name -> room_manager.UserInfo
	2,  // 2: room_manager.RoomService.LookRoom:input_type -> room_manager.LookRoomRequest
	4,  // 3: room_manager.RoomService.UpdateSpell:input_type -> room_manager.UpdateSpellRequest
	6,  // 4: room_manager.RoomService.RoomDone:input_type -> room_manager.RoomDoneRequest
	8,  // 5: room_manager.RoomService.QuitRoom:input_type -> room_manager.QuitRoomRequest
	10, // 6: room_manager.RoomService.RoomInfo:input_type -> room_manager.RoomInfoRequest
	3,  // 7: room_manager.RoomService.LookRoom:output_type -> room_manager.LookRoomResponse
	5,  // 8: room_manager.RoomService.UpdateSpell:output_type -> room_manager.UpdateSpellResponse
	7,  // 9: room_manager.RoomService.RoomDone:output_type -> room_manager.RoomDoneResponse
	9,  // 10: room_manager.RoomService.QuitRoom:output_type -> room_manager.QuitRoomResponse
	11, // 11: room_manager.RoomService.RoomInfo:output_type -> room_manager.RoomInfoResponse
